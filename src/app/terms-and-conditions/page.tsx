export default function Page() {
  return (
    <div className="container mx-auto mt-10 px-4 text-justify">
      <h2 className="text-center font-bold">
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to governorinitiative!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of governorinitiative&apos;s Website, located at
        https://www.governorsindh.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use governorinitiative if you do not
      ...
      <p>
        We employ the use of cookies. By accessing governorinitiative, you
        agreed to use cookies in agreement with the governorinitiative&apos;s
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, governorinitiative and/or its licensors own the
        intellectual property rights for all material on governorinitiative. All
        intellectual property rights are reserved. You may access this from
        governorinitiative for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from governorinitiative</li>
        <li>Sell, rent or sub-license material from governorinitiative</li>
        <li>Reproduce, duplicate or copy material from governorinitiative</li>
        <li>Redistribute content from governorinitiative</li>
      </ul>
      ...
      <p>
        ...
        governorinitiative does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of governorinitiative,its agents and/or affiliates.
        ...
        governorinitiative shall not be liable for the Comments or for any
      ...
      <p>
        governorinitiative reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant governorinitiative a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of governorinitiative; and (d) the
      ...
      <p>
        ...
        e-mail to governorinitiative. Please include your name, your
      ...
      <p>
        No use of governorinitiative&apos;s logo or other artwork will be
